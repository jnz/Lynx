...
CParticleSystemDust::CParticleSystemDust(const PROPERTYMAP& properties,
...
void CParticleSystemDust::InitParticle(particle_t& p, const vec3_t& ownerpos)
{
    ...
    p.vel = (m_dir + vec3_t::rand(1.5f, 5.5f, 1.5f)).Normalized() * 10.0f;
}
