    ...
    )
{
    ...
    sub_img = new unsigned char[sz*sz*channels];
    ...
    )
{
        ...
        (height > max_supported_size) )     /*  2^n for later down-sampling)    */
    {
        ...
        if( (new_width != width) || (new_height != height) )
        {
            ...
            unsigned char *resampled = new unsigned char[channels*new_width*new_height];
            up_scale_image(
                    img, width, height, channels,
    ...
    if( (width > max_supported_size) || (height > max_supported_size) )
    {
        ...
        resampled = new unsigned char[channels*new_width*new_height];
    ...
    if( tex_id )
    {
        ...
        if( flags & SOIL_FLAG_MIPMAPS )
        {
            ...
            unsigned char *resampled = new unsigned char[channels*MIPwidth*MIPheight];
    ...
    )
{
    ...
    pixel_data = new unsigned char[3*width*height];
